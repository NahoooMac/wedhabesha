    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center shadow-sm">
          ...
          <p className="text-gray-600">Message template management coming soon.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <button
          ...
          disabled={guestsWithPhone.length === 0}
          className="group bg-white border border-gray-200 rounded-lg p-6 hover:border-rose-300 hover:shadow-md transition-all text-left disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <h3 className="font-bold text-gray-900 mb-2">Send Event Updates</h3>
        ...
        >
          ...
          <h3 className="font-bold text-gray-900 mb-2">Bulk Messaging</h3>
          <p className="text-sm text-gray-500 mb-3">
        ...
        <button
          ...
          className="group bg-white border border-gray-200 rounded-lg p-6 hover:border-rose-300 hover:shadow-md transition-all text-left"
        >
          <div className="flex items-start justify-between mb-4">
        ...
        >
          ...
          <h3 className="font-bold text-gray-900 mb-2">Communication Analytics</h3>
          <p className="text-sm text-gray-500 mb-3">
        ...
        >
          ...
          <h3 className="font-bold text-gray-900 mb-2">Message History</h3>
          <p className="text-sm text-gray-500 mb-3">
