        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-900">Choose Invitation Template</h3>
                <p className="text-sm text-gray-500">Select a template design for your wedding invitations</p>
              </div>
              <button
                onClick={handleSaveTemplate}
                disabled={updateTemplateMutation.isPending}
                className="flex items-center gap-2 bg-rose-500 hover:bg-rose-600 disabled:bg-gray-400 text-white px-4 py-2 rounded-lg font-medium transition-colors"
              >
      ...
      {activeTab === 'preview' && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="text-center mb-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Invitation Preview</h3>
            <p className="text-sm text-gray-500">This is how your invitations will look to guests</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <button
              onClick={handleSaveTemplate}
              disabled={updateTemplateMutation.isPending}
              className="bg-rose-500 hover:bg-rose-600 disabled:bg-gray-400 text-white px-6 py-3 rounded-lg font-medium transition-colors"
            >
